...
public class ImageResizer extends ImageWorker {
    ...
    private Bitmap processBitmap(int resId) {
        if (Utils.DEBUG) Log.d(TAG, "processBitmap - " + resId);
    ...
    private Bitmap processBitmap(File file) {
        if (Utils.DEBUG) Log.d(TAG, "processBitmap - " + file.getAbsolutePath()); 
    	return decodeSampledBitmapFromFile(file.getAbsolutePath(), mImageWidth, mImageHeight);
    }
